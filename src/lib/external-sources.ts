...
export const EXTERNAL_SOURCES: readonly ExternalSource[] = [
  ...
  },
  {
    ...
    limitation: 'DBD/DOPA รองรับค้นอัตโนมัติเฉพาะเลข 13 หลักที่ตรวจ field contract แล้ว ส่วนการค้นชื่อและสถานที่/ทะเบียนยายังเป็นโหมดเปิดฟอร์ม LAW-i-RISK บน Cloudflare/Supabase ไม่รับรหัสผ่าน คำค้น หรือ session และทุกผลต้องให้เจ้าหน้าที่ตรวจ',
    services: [
      {
        key: 'DBD',
