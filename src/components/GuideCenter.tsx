...
const featureGuides: FeatureGuide[] = [
  ...
  },
  {
    ...
    summary: 'เปิดใช้เฉพาะระบบภายนอกที่ผ่านการทบทวนช่องทาง ความปลอดภัย และขอบเขตการใช้งานแล้ว',
    outcome: 'สืบค้นข้อมูลจากแหล่งทางการโดยไม่หลุดออกจากกรอบสิทธิ์และมาตรการความปลอดภัย',
    steps: ['อ่านสถานะและข้อจำกัดของแต่ละแหล่งก่อนเปิดใช้งาน', 'เลือกแหล่งที่ตรงกับวัตถุประสงค์ของคดี', 'บันทึกผลที่จำเป็นพร้อมวันเวลาและแหล่งอ้างอิง', 'หากระบบปิดปุ่มไว้ ให้ประสานผู้ดูแลแทนการหาทางเลี่ยงข้อจำกัด'],
    tips: ['ตั้งบัญชีผ่าน Recon Companion บนเครื่องเท่านั้น; HSS ต้องยืนยันความเสี่ยง HTTP ทุกครั้ง', 'นำเข้าข้อมูลเท่าที่เกี่ยวข้องกับภารกิจเท่านั้น'], roles: 'พนักงานสืบสวนที่ได้รับสิทธิ์',
  },
  {
    ...
    summary: 'รับไฟล์ต้นฉบับ ตรวจชนิดและความปลอดภัย เก็บค่าแฮช และรักษาประวัติการครอบครองหลักฐานตั้งแต่ต้นทาง',
    outcome: 'ได้หลักฐานที่ยืนยันต้นฉบับ ตรวจสอบย้อนกลับ และพร้อมเข้าสู่ขั้นตอนสกัดข้อมูล',
    steps: ['เลือกสำนวนคดีที่หลักฐานสังกัดและระบุแหล่งที่มา', 'ลากไฟล์หรือเลือกได้หลายไฟล์ โดยตรวจสถานะของแต่ละไฟล์ในคิว', 'แก้รายการที่ไม่ผ่านการตรวจชนิด ขนาด หรือลายเซ็นไฟล์ก่อนอัปโหลด', 'รอให้ระบบตรวจขนาด ชนิด และโครงสร้างไฟล์ก่อนนำไปประมวลผล', 'ใช้การดาวน์โหลดผ่านระบบเพื่อให้มีบันทึกการเข้าถึง'],
    tips: ['เก็บไฟล์ต้นฉบับ ห้ามแก้ไขแล้วอัปโหลดทับ', 'ตั้งชื่อไฟล์ให้สื่อความหมายแต่ไม่เปิดเผยข้อมูลเกินจำเป็น'], roles: 'พนักงานสืบสวน · ผู้ดูแลหลักฐาน',
  },
  {
