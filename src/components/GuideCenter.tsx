...
const featureGuides: FeatureGuide[] = [
  ...
  },
  {
    ...
    tips: ['ช่องทางที่ไม่มี HTTPS/API ที่ปลอดภัยจะถูกปิดโดยอัตโนมัติ', 'นำเข้าข้อมูลเท่าที่เกี่ยวข้องกับภารกิจเท่านั้น'], roles: 'พนักงานสืบสวนที่ได้รับสิทธิ์',
  },
  {
    ...
    steps: ['เลือกสำนวนคดีที่หลักฐานสังกัดและระบุแหล่งที่มา', 'ลากไฟล์หรือเลือกได้หลายไฟล์ โดยตรวจสถานะของแต่ละไฟล์ในคิว', 'แก้รายการที่ไม่ผ่านการตรวจชนิด ขนาด หรือลายเซ็นไฟล์ก่อนอัปโหลด', 'รอการตรวจความปลอดภัยจนได้สถานะ CLEAN ก่อนนำไปประมวลผล', 'ใช้การดาวน์โหลดผ่านระบบเพื่อให้มีบันทึกการเข้าถึง'],
