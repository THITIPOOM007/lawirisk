...
const featureGuides: FeatureGuide[] = [
  ...
  },
  {
    ...
    steps: ['อ่านสถานะและข้อจำกัดของแต่ละแหล่งก่อนเปิดใช้งาน', 'เลือกแหล่งที่ตรงกับวัตถุประสงค์ของคดี แล้วกดตั้ง/เปลี่ยนบัญชีบนเครื่องนี้เฉพาะครั้งแรกหรือเมื่อต้องเปลี่ยนรหัส', 'เริ่มค้นหาและดูสถานะ LIVE ACQUISITION บนหน้าคดีแทนการรอหน้าต่าง PowerShell', 'เมื่อสถานะ COMPLETE ให้ตรวจผล PDF และภาพผลค้นในคลังหลักฐาน พร้อมวันเวลา URL และ SHA-256', 'หากสถานะ PAUSED หรือ FAILED ให้เปิดเหตุผลที่ระบบแสดง แก้เฉพาะสาเหตุที่ระบุ แล้วจึงลองใหม่', 'หากระบบปิดปุ่มไว้ ให้ประสานผู้ดูแลแทนการหาทางเลี่ยงข้อจำกัด'],
    tips: ['ตั้งบัญชีผ่าน Recon Companion บนเครื่องเท่านั้น; HSS ต้องยืนยันความเสี่ยง HTTP ทุกครั้ง', 'หน้าต่างเบราว์เซอร์อาจเปิดเมื่อ Companion ทำงาน แต่ PowerShell ถูกซ่อนไว้โดยออกแบบและไม่ใช่ตัวบ่งชี้ความล้มเหลว', 'นำเข้าข้อมูลเท่าที่เกี่ยวข้องกับภารกิจเท่านั้น'], roles: 'พนักงานสืบสวนที่ได้รับสิทธิ์',
  },
  {
