...
เมื่อหน้าเว็บแจ้งว่า **Recon Companion เป็นรุ่นเก่า** ให้ดาวน์โหลดและรันตัวติดตั้งล่าสุดจากหน้า “แหล่งสืบค้นข้อมูล” ก่อนเริ่มงานใหม่ ตัวติดตั้งจะอัปเดต Local Bridge และเริ่มใหม่อัตโนมัติ รุ่นที่รองรับต้องเก็บผลค้นครบทั้ง PDF และภาพ PNG; ระบบจะไม่เริ่มงานกับรุ่นเก่าที่เก็บได้เพียง PDF เพื่อป้องกันข้อความ 404 ที่ทำให้เข้าใจผิดว่าแหล่งข้อมูลค้นไม่สำเร็จ
